...
PAGES = {
  ...
  "en/aikido-training-gdynia.html" => "views.en.training_gdynia",
  "en/first-aikido-training-gdynia.html" => "views.en.first_training_gdynia",
  "faq.html" => "views.faq",
  ...
  "blog/uke-i-nage-relacja-ktora-uczy.html" => "views.blog.uke_i_nage",
  ...
  "en/blog/uke-and-nage-a-learning-relationship.html" => "views.en.blog.uke_and_nage",
  ...
  "404.html" => "views.not_found",
    ...
    def copy_static_assets(root, export_dir)
      ...
      FileUtils.mkdir_p File.join(export_dir, "assets/svg")
      FileUtils.cp File.join(root, "assets/svg/toyoda_sigil.svg"), File.join(export_dir, "assets/svg/toyoda_sigil.svg")
