  ...
  module View
    class Context < Dry::View::Context
      ...
      BLOG_POSTS_EN = [
        ...
        { date: "June 11, 2026", title: "Uke i nage (受・投げ) — relacja, która uczy", url: "/en/blog/uke-i-nage-relacja-ktora-uczy.html", summary: "Uke i nage are not opponents or performers in a show. They are two sides of one lesson about mutual responsibility, honest contact, and real learning." },
