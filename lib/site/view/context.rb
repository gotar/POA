  ...
  module View
    class Context < Dry::View::Context
      ...
      def default_title_for_path(path)
        ...
        when "kontakt.html"
          "Kontakt i grafik treningów Aikido | Gdynia | Sesshinkan Dojo"
        ...
        when "faq.html"
          "FAQ Aikido Gdynia | Pytania o treningi i pierwszy trening | POA"
        when "gdynia.html"
          "Treningi Aikido w Gdyni | Grafik, lokalizacja i pierwszy trening | Sesshinkan Dojo"
        when "treningi-aikido-gdynia.html"
          "Treningi Aikido w Gdyni | Wieczorne zajęcia dla dorosłych | Sesshinkan Dojo"
        when "pierwszy-trening-aikido-gdynia.html"
          "Pierwszy trening Aikido Gdynia | Co zabrać i jak zacząć | Sesshinkan Dojo"
        when "aikido-dla-doroslych-gdynia.html"
          "Aikido dla dorosłych Gdynia | Wieczorne treningi | Sesshinkan Dojo"
        when "yudansha.html"
        ...
        when "blog/egzamin-w-budo-pokaz-drogi-nie-wystep.html"
          "Egzamin w budō — pokaz drogi, nie występ przed komisją | Blog"
        ...
        when "en/blog/exams-in-budo-showing-the-road-not-performing.html"
          "Exams in Budō — showing the road, not performing for the panel | Blog"
      ...
      def default_description_for_path(path)
        ...
        when "kontakt.html"
          "Kontakt, grafik i lokalizacja treningów Aikido w Gdyni. Sprawdź adres dojo, telefon, e-mail, godziny zajęć, dojazd oraz informacje o pierwszym treningu w Sesshinkan Dojo Gdynia."
        when "aikido/czym_jest.html"
        ...
        when "aikido/dla_poczatkujacych.html"
          "Aikido dla początkujących w Gdyni: jak wyglądają zajęcia dla dorosłych, co zabrać na pierwszy trening, czego się spodziewać i jak zacząć w Sesshinkan Dojo."
        when "aikido/aiki_taiso.html"
        ...
        when "faq.html"
          "FAQ o Aikido w Gdyni: odpowiedzi o pierwszym treningu, kosztach, stroju, grafiku, lokalizacji dojo i rozpoczęciu zajęć w Sesshinkan Dojo."
        when "gdynia.html"
          "Treningi Aikido w Gdyni w Sesshinkan Dojo: grafik zajęć, lokalizacja dojo, pierwszy trening gratis, instruktor oraz praktyczne informacje dla początkujących i dorosłych."
        when "treningi-aikido-gdynia.html"
          "Treningi Aikido w Gdyni dla dorosłych i początkujących: grafik, miejsce zajęć, przebieg treningu i praktyczne informacje o starcie w Sesshinkan Dojo."
        when "pierwszy-trening-aikido-gdynia.html"
          "Pierwszy trening Aikido w Gdyni krok po kroku: co zabrać, jak wygląda wejście na matę, czy można zacząć bez doświadczenia i jak przygotować się do zajęć."
        when "aikido-dla-doroslych-gdynia.html"
          "Aikido dla dorosłych w Gdyni: wieczorne treningi dla osób początkujących i pracujących. Sprawdź, dla kogo są zajęcia i jak zacząć w Sesshinkan Dojo."
        when "en/contact.html"
        ...
        when "blog/egzamin-w-budo-pokaz-drogi-nie-wystep.html"
          "Egzamin w budō i aikido jako uczciwy sprawdzian drogi, przygotowania i odpowiedzialności — nie występ przed komisją ani sąd nad wartością człowieka."
        when "blog/ukemi-bezpiecznie-upasc-zachowac-strukture-wrocic-do-dzialania.html"
        ...
        when "blog/nemawashi-przygotowanie-gruntu-przed-dzialaniem.html"
          "Nemawashi w Aikido i budō: dlaczego dobra technika, korekta i rozwój dojo wymagają przygotowania gruntu przed widocznym działaniem."
        when "blog/misogi-oczyszczenie-przez-praktyke.html"
        ...
        when "en/blog/exams-in-budo-showing-the-road-not-performing.html"
          "A budō and Aikido exam as an honest test of training, preparation, and responsibility — not a performance for the panel or a judgment of personal worth."
        when "en/blog/ukemi-falling-safely-keeping-structure-returning-to-action.html"
        ...
        when "en/blog/nemawashi-laying-groundwork-before-action.html"
          "Nemawashi in Aikido and budō: why good technique, correction, and dojo development require groundwork before visible action."
        when "en/blog/misogi-purification-through-practice.html"
      ...
      def default_keywords_for_path(path)
        ...
        when "kontakt.html"
          "kontakt aikido gdynia, grafik aikido gdynia, sesshinkan dojo gdynia, treningi aikido gdynia, pierwszy trening aikido gdynia, telefon dojo, adres dojo gdynia"
        when "aikido/czym_jest.html"
        ...
        when "aikido/dla_poczatkujacych.html"
          "aikido dla początkujących gdynia, pierwszy trening aikido gdynia, podstawy aikido, dojo gdynia, trening aikido dorośli gdynia, aikido gdynia dla dorosłych"
        when "aikido/aiki_taiso.html"
        ...
        when "faq.html"
          "faq aikido gdynia, pytania o aikido, pierwszy trening aikido gdynia, ile kosztuje aikido gdynia, strój na aikido, grafik aikido gdynia"
        when "gdynia.html"
          "treningi aikido w gdyni, aikido gdynia, sesshinkan dojo gdynia, aikido dla początkujących gdynia, pierwszy trening aikido gdynia, sztuki walki gdynia dorośli"
        when "treningi-aikido-gdynia.html"
          "treningi aikido w gdyni, zajęcia aikido gdynia, aikido gdynia grafik, sesshinkan dojo gdynia, dojo gdynia, aikido trójmiasto"
        when "pierwszy-trening-aikido-gdynia.html"
          "pierwszy trening aikido gdynia, jak zacząć aikido gdynia, co zabrać na aikido, aikido dla początkujących gdynia, trening próbny aikido gdynia"
        when "aikido-dla-doroslych-gdynia.html"
          "aikido dla dorosłych gdynia, sztuki walki gdynia dorośli, trening aikido dorośli gdynia, aikido początkujący dorośli gdynia, wieczorne treningi aikido gdynia"
        when "en/contact.html"
        ...
        when "blog/ikigai-sens-regularnej-praktyki.html"
          "ikigai aikido, ikigai, sens praktyki, regularny trening aikido, motywacja w dojo, powrót na matę, droga budo, shoshin, kultura japonska"
        when "blog/mottainai-nie-marnuj-tego-co-moze-cie-nauczyc.html"
        ...
        when "blog/egzamin-w-budo-pokaz-drogi-nie-wystep.html"
          "egzamin w budo, egzamin aikido, stopnie aikido, budo, aikido, trening aikido, hansei, odpowiedzialność w dojo, przygotowanie do egzaminu"
        when "blog/ukemi-bezpiecznie-upasc-zachowac-strukture-wrocic-do-dzialania.html"
        ...
        when "blog/nemawashi-przygotowanie-gruntu-przed-dzialaniem.html"
          "nemawashi aikido, przygotowanie gruntu, korekta w aikido, rozwój dojo, zmiana w dojo, budo, kultura japonska"
        when "blog/misogi-oczyszczenie-przez-praktyke.html"
        ...
        when "en/blog/ikigai-the-reason-to-return-to-practice.html"
          "ikigai aikido, ikigai, meaning of practice, regular aikido training, dojo motivation, return to the mat, budo path, shoshin, Japanese culture"
        when "en/blog/mottainai-do-not-waste-what-can-teach-you.html"
        ...
        when "en/blog/exams-in-budo-showing-the-road-not-performing.html"
          "budo exam, aikido grading, aikido exam, martial arts grading, budo, aikido training, hansei, dojo responsibility, preparing for grading"
        when "en/blog/ukemi-falling-safely-keeping-structure-returning-to-action.html"
        ...
        when "en/blog/nemawashi-laying-groundwork-before-action.html"
          "nemawashi aikido, laying groundwork, aikido correction, dojo development, change in the dojo, budo, Japanese culture"
        when "en/blog/misogi-purification-through-practice.html"
