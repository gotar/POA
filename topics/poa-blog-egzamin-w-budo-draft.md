# POA blog draft — Egzamin w budō

Status: **draft / not published**
Date drafted: 2026-06-13
Related research: `/var/projects/POA/topics/poa-blog-egzamin-w-budo-research.md`
Publication note: Do **not** publish or register in blog index until Oskar approves.

## Working publication metadata

### Polish
- Proposed title: `Egzamin w budō — pokaz drogi, nie występ przed komisją`
- Proposed public URL: `/blog/egzamin-w-budo-pokaz-drogi-nie-wystep.html`
- Proposed summary: `Egzamin w budō nie tworzy jakości. Odsłania drogę, którą uczeń naprawdę przeszedł: regularność, korektę, oddech, kontakt, błędy i odpowiedzialność za dalszy trening.`
- Proposed SEO description: `Egzamin w budō i aikido jako uczciwy sprawdzian drogi, przygotowania i odpowiedzialności — nie występ przed komisją ani sąd nad wartością człowieka.`
- Proposed keywords: `egzamin w budo, egzamin aikido, stopnie aikido, budo, aikido, trening aikido, hansei, odpowiedzialność w dojo, przygotowanie do egzaminu`

### English
- Proposed title: `Exams in Budō — showing the road, not performing for the panel`
- Proposed public URL: `/en/blog/exams-in-budo-showing-the-road-not-performing.html`
- Proposed summary: `A budō exam does not create quality. It reveals the road already walked: regular practice, correction, breath, contact, mistakes, and responsibility for what comes next.`
- Proposed SEO description: `A budō and Aikido exam as an honest test of training, preparation, and responsibility — not a performance for the panel or a judgment of personal worth.`
- Proposed keywords: `budo exam, aikido grading, aikido exam, martial arts grading, budo, aikido training, hansei, dojo responsibility, preparing for grading`

---

# Polish draft

## Egzamin w budō — pokaz drogi, nie występ przed komisją

**Egzamin w budō nie zaczyna się w dniu egzaminu. Zaczyna się dużo wcześniej: w zwykłych treningach, w przyjmowaniu korekty, w powrotach po błędzie, w pracy nad tym, czego najchętniej byśmy unikali. Komisja widzi kilka minut. Uczeń wie, czy za tymi minutami stoją miesiące uczciwej pracy.**
...
Nie: „czy dobrze wyglądałem?”.
Nie: „czy komisja była zadowolona?”.
Nie nawet: „czy zdałem?”.
...
Ale samo okno nie jest całym domem.
...
Wie, ile razy był na macie, kiedy nie miał ochoty. Wie, czy słuchał korekty, czy tylko kiwał głową. Wie, czy po treningu wracał do trudnej techniki, czy zostawiał ją na później. Wie, czy szukał prawdy, czy potwierdzenia. Wie, czy przygotowanie było uczciwe, czy tylko nerwowe.

Dlatego najważniejszy egzamin odbywa się przed wejściem na matę.

Można to porównać do rachunku sumienia. Nie chodzi o religijny ton ani o poczucie winy. Chodzi o prostą, surową uczciwość. Tak jak w spowiedzi ważniejszy od samej chwili wypowiedzenia formuły jest wcześniejszy rachunek sumienia, tak w egzaminie ważniejszy od ukłonu przed komisją jest moment, w którym człowiek potrafi powiedzieć sobie bez ozdabiania: pracowałem albo nie pracowałem; poprawiałem albo omijałem; wracałem albo uciekałem; nie oszukiwałem siebie albo właśnie próbuję.

To nie ma prowadzić do teatralnej skruchy. Ma prowadzić do konkretu.

Jeśli nie pracowałem — zaczynam pracować.
Jeśli unikałem słabego miejsca — przestaję je omijać.
Jeśli przyjmowałem korektę tylko pozornie — uczę się naprawdę ją przyjmować.
Jeśli chcę stopnia bardziej niż zmiany — muszę to zobaczyć, zanim stopień mnie przykryje.

Hansei, uczciwa autorefleksja, nie jest nastrojem. Jest narzędziem. Egzamin bez hansei łatwo staje się spektaklem. Egzamin z hansei może stać się punktem zwrotnym.
...
Na zwykłym treningu można schować się w rytmie grupy. Można ćwiczyć z ulubionym partnerem. Można przejść przez słabszy moment mniej widocznie. Można poprawić technikę w następnym powtórzeniu, bez poczucia, że ktoś patrzy. Egzamin zabiera część tych zasłon.
...
Dlatego nie chodzi o to, żeby zdający nic nie czuł. To byłoby nierealne. Chodzi o to, żeby mimo odczuwania wrócił do pracy.
...
The belts are tied. The emotion starts to settle. Someone is relieved. Someone is still replaying a mistake. Someone is trying to understand why the body failed at a place that had seemed simple the day before. From the outside, one could say the examination is over.

But often the most important question arrives only then.

Not: “Did I look good?”
Not: “Was the panel satisfied?”
Not even: “Did I pass?”
...
In the dojo it is easy to confuse the date of an exam with the beginning of preparation. A student hears that they may test, so they suddenly attend more often, repeat the required techniques, ask about details, pay attention to etiquette, and remember the names. That is good if the exam helps organize attention. It is poor practice if the exam is expected to replace the work that should already have been done.

An exam does not create quality. It reveals it.

Under pressure, what has truly been trained comes out. So does what has been avoided. If, for months, a student has worked on posture, contact, ukemi, breath, entry, distance, and the ability to receive correction, the exam will usually show that — even if a mistake appears. If, for months, the student has collected fragments, trained irregularly, and hoped the body will somehow mobilize itself on the day, the exam will show that too — even if one technique looks impressive.

This is why preparing for an exam is not only drilling the list. The list matters. Requirements matter. Minimum training time, the material for the rank, kihon waza, ukemi, suwari waza, hanmi handachi, different attacks, weapons, randori, etiquette — all of this gives the path a frame. Without a frame, practice easily becomes vague.
...
They know how often they came to the mat when they did not feel like it. They know whether they listened to correction or only nodded. They know whether they returned to the difficult technique after class or left it for later. They know whether they were looking for truth or for confirmation. They know whether the preparation was honest or only anxious.

That is why the most important exam happens before stepping onto the mat.

In Polish, one might compare this to a rachunek sumienia — an examination of conscience. The point is not guilt, religion, or theatrical remorse. The point is direct self-examination. Before bowing to the panel, can I say plainly: I worked, or I did not; I corrected, or I avoided; I returned, or I escaped; I did not lie to myself, or I am trying to do exactly that now?

This should not lead to drama. It should lead to work.

If I did not train honestly — I begin.
If I avoided a weak place — I stop avoiding it.
If I only pretended to receive correction — I learn to receive it for real.
If I want the rank more than the change — I need to see that before the rank covers it.
...
In ordinary training, a student can hide inside the rhythm of the group. They can work with a favorite partner. A weaker moment may pass without being noticed. A technique can be corrected in the next repetition without the feeling that everyone is watching. An exam removes some of those screens.
...
The worst thing one can do after an exam is treat rank as closure.
...
A beginner after a first exam often receives something valuable: proof that they have entered the road and can continue. That builds trust. But it also ends one excuse: “I am completely new.” From now on, more must be remembered, more must be seen, more must be carried.
...
A senior student has even less room for posing. Their rank is visible in how they attack as uke, how they guide juniors, how they receive correction, how they protect safety, and how they take care of the dojo before and after training. If rank only gives them a higher place in the line, it has been misunderstood.

After an exam, the right question is not: “What did I get?”

It is: “What does the road now require of me?”

### The exam also tests the dojo

One more thing should be said: an exam does not test only the candidate. It also tests the teacher and the dojo.
...
If that information is good, it should not produce self-satisfaction. If it is difficult, it should not produce shame. In both cases, it should return to the mat as more precise work.

### Outside the dojo, there are exams too

There is no need to abuse the metaphor. Life is not an examination hall, and every difficult day is not shinsa. But budō teaches us to recognize a mechanism.

Human beings are rarely tested when everything is comfortable. The test comes when someone criticizes us. When we have to admit a mistake. When a child watches how we handle our own frustration. When, at work, we need to tell the truth instead of hiding behind an elegant excuse. When fatigue lowers the quality of speech. When ambition wants the reward before the work has been done.
...
That is why exams are worth doing. Not for the belt as an object. Not for a photograph. Not for a temporary inflation of ego. They are worth doing because a well-set exam forces the road into order. It checks whether practice is real or only declared. It gives teacher and student a common language for the next stage of work.

You face the teacher briefly. You face yourself every day.

If an exam has meaning, it is because it does not allow us to keep telling ourselves stories about our training forever. For a moment everything becomes simple. Bow. Breath. Attack. Technique. Mistake. Return. Next movement.
